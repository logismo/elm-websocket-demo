...
var $author$project$Main$init = function (flags) {
	return _Utils_Tuple2(
		{draft: 'bubble', messages: _List_Nil, selectedValue: $elm$core$Maybe$Nothing},
			...
			case 'DropdownChanged':
				...
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							draft: A2($elm$core$Maybe$withDefault, 'bubble', selectedValue)
						}),
					$elm$core$Platform$Cmd$none);
			default:
	...
	return _Utils_update(
		defaultOptions,
		{
			items: _List_fromArray(
				[
					{enabled: true, text: 'Bubble Sort', value: 'bubble'},
					{enabled: true, text: 'Selection Sort', value: 'selection'},
					{enabled: true, text: 'Merge Sort', value: 'merge'}
				])
		});
}();
					...
					[
						...
						_List_fromArray(
							[
								...
								A3($abadi199$elm_input_extra$Dropdown$dropdown, $author$project$Main$dropdownOptions, _List_Nil, model.selectedValue)
							])),
						A2(
